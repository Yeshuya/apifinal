...
// Render Facebook login button 
    $facebook_login_url = '<div align="center"><a href="'.$facebook_login_url.'"><img style="width:510px; height: 140px; margin-top: -20px; margin-left: 2px;"src="images/face.png" /></a></div>';
}
